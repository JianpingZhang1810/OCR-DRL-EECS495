...
__C.TRAIN.RPN_BATCHSIZE = 256#128#256
...
# Learning rate etc
__C.DRL_RPN_TRAIN.LEARNING_RATE = 0.00002#0.00002
...
__C.DRL_RPN_TRAIN.BETAS = [0.0,0.0]
...
__C.DRL_RPN_TRAIN.POST_BETAS = [0.0, 0.0]
...
__C.DRL_RPN.H_FIXRECT = .25 #.25
__C.DRL_RPN.W_FIXRECT = .25 #.25
...
__C.DRL_RPN.MAX_ITER_TRAJ = 3#3#13!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
__C.POOLING_SIZE_W = 11 #7
__C.POOLING_SIZE_H = 6 #7

# Base feature map dimensionality
__C.DIMS_BASE = 512

# Number of classes
__C.NBR_CLASSES = 2 #2 #21
