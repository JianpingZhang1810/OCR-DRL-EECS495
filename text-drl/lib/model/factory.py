...
def do_hist_update(rl_input, cls_probs_uptonow, pred_bboxes_uptonow, keeps,
  ...
  if not rl_in_upsamp_height is None:
    for curr_bin_assignment in range(nms_prod):
      ...
      ctr_width = curr_bin_assignment // cfg.DRL_RPN.W_HIST    # HERE USE PYTHON 3 // to replace /
      ...
      # print (type(1))
      # print (type(int(rl_hist_wend - rl_hist_wstart)))
...
def run_drl_rpn(sess, net, blob, timers, mode, beta, im_idx=None,
  ...
  print (rl_in.shape)
  print (rl_hid.shape)
  print (rois_all.shape)
  print (roi_obs_vol.shape)
  print (rpn_cls_objness_topK)
  print (rpn_cls_objness_vec.shape)
  print (height)
  print (width)
  print (height_orig)
  print (width_orig)
  ...
  print (h_ratio_orig)
  print (w_ratio_orig)
  print (fix_rect_h_orig)
  print (fix_rect_w_orig)
  print (not_keep_ids_agno_nms.shape)
  '''
  ...
  for t in range(cfg.DRL_RPN.MAX_ITER_TRAJ): 
    ...
    if t > 0:
      ...
      if cfg.DRL_RPN.USE_HIST:
        ...
        #print ('HAHAHAAHAHAHAHAHAHAHAH')
        #print (rl_in.shape)
        #print (keeps_nms)
        #print (cls_probs_uptonow.shape)
        #print (pred_bboxes_uptonow.shape)
        #print ('BABABABABABABABABBABABABA')
